...
const ConversationCard = ({
  ...
  return (
    <div className={styles.ConversationCard_container} onClick={onClick} style={{
      ...
      <Image src={`https://api.dicebear.com/8.x/avataaars/svg?seed=${conversation.name.toLowerCase()}&radius=22&backgroundColor=65c9ff,b6e3f4,c0aede,d1d4f9,ffd5dc,ffdfbf&randomizeIds=true`} alt="ConversationCardIcon" width={60} height={60} />
